...
$result = mysqli_query($connection, "SELECT * FROM Records WHERE PatientID=2"); 
...
function DeleteAllRecords($connection) {
  if(!mysqli_query($connection, "DELETE FROM Records WHERE PatientID=2")) echo("<p>Error deleting patient data, please ensure there is data to be deleted</p>");
}
